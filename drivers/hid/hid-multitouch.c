...
#define MT_CLS_GENERALTOUCH_PIT_TENFINGERS      0x0108
...
static struct mt_class mt_classes[] = {
	...
	{ .name = MT_CLS_PANASONIC,
        ...
        { .name = MT_CLS_GENERALTOUCH_PIT_TENFINGERS,
                .quirks = MT_QUIRK_NOT_SEEN_MEANS_UP |
                          MT_QUIRK_SLOT_IS_CONTACTID,
        },
	{ }
...
static const struct hid_device_id mt_devices[] = {
	...
	{ .driver_data = MT_CLS_GENERALTOUCH_TWOFINGERS,
        ...
        { .driver_data = MT_CLS_GENERALTOUCH_PIT_TENFINGERS,
		HID_USB_DEVICE(USB_VENDOR_ID_GENERAL_TOUCH,
			USB_DEVICE_ID_GENERAL_TOUCH_WIN8_PIT_0100) },
        { .driver_data = MT_CLS_GENERALTOUCH_PIT_TENFINGERS,
		HID_USB_DEVICE(USB_VENDOR_ID_GENERAL_TOUCH,
			USB_DEVICE_ID_GENERAL_TOUCH_WIN8_PIT_0102) },
        { .driver_data = MT_CLS_GENERALTOUCH_PIT_TENFINGERS,
		HID_USB_DEVICE(USB_VENDOR_ID_GENERAL_TOUCH,
			USB_DEVICE_ID_GENERAL_TOUCH_WIN8_PIT_0104) },
        { .driver_data = MT_CLS_GENERALTOUCH_PIT_TENFINGERS,
		HID_USB_DEVICE(USB_VENDOR_ID_GENERAL_TOUCH,
			USB_DEVICE_ID_GENERAL_TOUCH_WIN8_PIT_0105) },
        { .driver_data = MT_CLS_GENERALTOUCH_PIT_TENFINGERS,
		HID_USB_DEVICE(USB_VENDOR_ID_GENERAL_TOUCH,
			USB_DEVICE_ID_GENERAL_TOUCH_WIN8_PIT_0106) },
        { .driver_data = MT_CLS_GENERALTOUCH_PIT_TENFINGERS,
		HID_USB_DEVICE(USB_VENDOR_ID_GENERAL_TOUCH,
			USB_DEVICE_ID_GENERAL_TOUCH_WIN8_PIT_0107) },
